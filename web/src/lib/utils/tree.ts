 ...
 * add caching without a measured reason to. addMove mutates in place;
 * callers in React state must produce a new root reference after
 * calling it, this file does not do that for you.
 */
